...
def add_pipeline_status(engine, case_id, tumor_gdc_id, normal_gdc_id, output_id,
    ...
    met = statusclass(case_id           = case_id,
...
def set_download_error(exit_code, logger, engine,
                       case_id, tumor_gdc_id, normal_gdc_id, output_id,
    ...
    if exit_code != 0:
        ...
        add_pipeline_status(engine, case_id, tumor_gdc_id, normal_gdc_id, output_id,
                            status, s3_url, datetime_start, datetime_end,
                            md5, file_size, hostname, cwl_version, docker_version, statusclass)
        add_pipeline_metrics(engine, case_id, tumor_gdc_id, normal_gdc_id, download_time, float(0),

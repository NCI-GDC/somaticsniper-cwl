...
basedir=`sudo mktemp -d somaticsniper.XXXXXXXXXX -p /mnt/SCRATCH/`
refdir="XX_REFDIR_XX"
s3dir="XX_S3DIR_XX"
...
sudo git clone -b feat/develop $repository somaticsniper-cwl
sudo chown ubuntu:ubuntu -R somaticsniper-cwl
...
--sort $basedir/somaticsniper-cwl/tools/picard-sortvcf.cwl \
--s3dir $s3dir \
